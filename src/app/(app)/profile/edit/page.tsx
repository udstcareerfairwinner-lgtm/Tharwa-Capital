    ...
    <div>
        <header className="bg-gradient-to-br from-primary to-green-600 text-primary-foreground p-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
                <h1 className="text-3xl font-bold font-headline mb-1">Edit Profile</h1>
            </div>
        </header>
        ...
        <div className="p-4 md:p-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>This feature is coming soon. You'll be able to update your personal information here.</CardDescription>
                </CardHeader>
                <CardContent>
